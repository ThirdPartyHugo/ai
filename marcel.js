...
async function main() {
  try {
    ...
    const file = await openai.files.create({
      file: fs.createReadStream("zappdata.txt"),
      purpose: "assistants",
    });
    ...
    const assistant = await openai.beta.assistants.create({
      name: "marcel",
      instructions:
        "You are my new assistant for my site Zapptele.com that sells iptv subscriptions, you will be awnsering to clients and must act as such",
    ...
    console.log(
      "\nWelcome to Zapptele, how may i help you today \n"
    );
    // Create a thread
